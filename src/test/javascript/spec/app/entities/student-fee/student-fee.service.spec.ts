...
describe('Service Tests', () => {
    describe('StudentFee Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new StudentFee(0, 0, 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a StudentFee', async () => {
            ...
            it('should update a StudentFee', async () => {
                const returnedFromService = Object.assign(
                    {
                        totalFee: 1,
                        feePaid: 1
            ...
            it('should return a list of StudentFee', async () => {
                const returnedFromService = Object.assign(
                    {
                        totalFee: 1,
                        feePaid: 1
            ...
            it('should delete a StudentFee', async () => {
