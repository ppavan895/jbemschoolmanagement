...
describe('Service Tests', () => {
    describe('Attendence Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Attendence(0, currentDate, false);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Attendence', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        date: currentDate.format(DATE_FORMAT)
            ...
            it('should update a Attendence', async () => {
                const returnedFromService = Object.assign(
                    {
                        date: currentDate.format(DATE_FORMAT),
                        present: true
            ...
            it('should return a list of Attendence', async () => {
                const returnedFromService = Object.assign(
                    {
                        date: currentDate.format(DATE_FORMAT),
                        present: true
            ...
            it('should delete a Attendence', async () => {
